...
-- Tu respuesta aquí
SELECT COUNT(id_usuario) FROM usuarios_lenguajes WHERE lenguaje='JavaScript'
...
-- Tu respuesta aquí
SELECT nombre FROM usuarios_lenguajes WHERE edad BETWEEN 25 AND 35 AND lenguaje IS NOT NULL

-- Ejercicio 20: Contar cuántos usuarios tienen un lenguaje asociado llamado 'CSS' y tienen menos de 30 años.
-- Tu respuesta aquí
SELECT COUNT(lenguaje) FROM usuarios_lenguajes WHERE edad < 30 AND lenguaje='CSS'
...
-- Tu respuesta aquí
SELECT nombre FROM usuarios_lenguajes WHERE edad IN (SELECT edad FROM usuarios_lenguajes GROUP BY edad HAVING COUNT(edad) > 1)
...
-- Tu respuesta aquí
 SELECT lenguaje FROM usuarios_lenguajes WHERE edad > 29 ORDER BY LENGTH(lenguaje) DESC LIMIT 1

-- Ejercicio 35: Seleccionar los usuarios y mostrar la diferencia entre su edad y la edad promedio de todos los usuarios
-- Tu respuesta aquí
SELECT nombre, (edad - (SELECT AVG(edad) FROM usuarios_lenguajes)) AS diferencia_edad FROM usuarios_lenguajes;
...
-- Tu respuesta aquí
SELECT COUNT(lenguaje) FROM usuarios_lenguajes WHERE lenguaje < 28 AND lenguaje LIKE 'P%'
